                ...
                <h1 className="text-3xl sm:text-4xl md:text-6xl font-bold space-y-2 sm:space-y-4">
                  ...
                  <div>
                    <span
                        data-aos="fade-up"
                        data-aos-delay="800"
                        className="inline-block px-2 bg-gradient-to-r from-blue-400 to-teal-500 bg-clip-text text-transparent"
                    >
                      Portfolio
                    </span>
                    {' '}
                    <span
                        data-aos="fade-up"
                        data-aos-delay="1000"
                        className="inline-block px-2 bg-gradient-to-r from-indigo-400 to-cyan-500 bg-clip-text text-transparent"
                    >
                      Website
                    </span>
                  </div>
              ...
              >
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    ...
                    <span
                        className="inline-block px-2 bg-gradient-to-r from-blue-400 to-teal-500 bg-clip-text text-transparent">
                      <TypewriterEffect text="www.yasith.web.lk"/>
                    </span>
                  </div>
                </a>
              </motion.div>
